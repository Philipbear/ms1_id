...
def annotate_ms1_id(spec_ls,
    ...
    :param spec_ls: a list of PseudoMS2-like object
...
if __name__ == "__main__":
    ...
    # annotate spectra
    annotated_spectra = annotate_ms1_id(spec_ls=ms1_spectra,
